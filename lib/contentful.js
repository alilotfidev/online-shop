...
const apiBaseUrl = `${process.env.CONTENTFUL_CONTENT_MANAGEMENT_BASE_URL}/spaces/${process.env.CONTENTFUL_SPACE_ID}/environments/${process.env.CONTENTFUL_ENVIRONMENT_ID}/entries`;
